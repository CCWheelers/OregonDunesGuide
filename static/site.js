...
function renderTownsGuide(page){
  const gateways=[
    ["01","Florence","Best all-around first base","Old Town, lakes, lodging, groceries, and north-dunes access.","camp-region-florence.webp","#town-florence"],
    ["02","Winchester Bay & Reedsport","Best for a focused riding trip","Harbor camping and Umpqua Dunes access, backed by Reedsport services.","camp-region-winchester-bay.webp","#town-winchester"],
    ["03","Lakeside","Best for lake-and-dunes balance","A quieter freshwater base near paddling, fishing, and central-south access.","map-lakeside.webp","#town-lakeside"],
    ["04","Coos Bay & North Bend","Best full-service south base","The widest choice of stores, repairs, lodging, dining, and south-dunes access.","camp-region-coos-bay.webp","#town-coos"]
  ];
...
function renderWildlifeGuide(page){
  const habitats=[
    ...
    ["FOREST EDGE","Shore pine & meadow","The transition from forest to grass and wet meadow creates cover, forage, and travel corridors.","wildlife-hero-elk.webp","#wildlife-elk"],
...
function renderConditionsGuide(page){
  const regionCards=[
    ["florence","01","FLORENCE","South Jetty & Siltcoos","riding-01-florence.webp"],
    ["winchester","02","WINCHESTER BAY","Umpqua Dunes","riding-02-winchester.webp"],
    ["coos","03","COOS BAY","Spinreel & Horsfall","riding-03-coos-bay.webp"]
  ...
  <div class="guide-content conditions-content">
    ...
    <section id="conditions-official"><span class="section-number">02</span><p class="conditions-eyebrow">THE SOURCES THAT MAKE THE CALL</p><h2>Open the live status&mdash;not an old screenshot.</h2><p class="conditions-lead">This guide cannot declare a road, beach, trail, campground, or riding area open. These official pages carry the current notices.</p><div class="conditions-status-grid">
      ...
      <a class="conditions-status-card status-roads" href="https://tripcheck.com/" target="_blank" rel="noopener"><img src="public/images/map-reedsport.webp" data-fallback-src="/images/map-reedsport.webp" alt="" aria-hidden="true"><div><span>OREGON DOT</span><h3>Roads & cameras</h3><p>Incidents, construction, delays, weather warnings, and cameras on US 101 and approach routes.</p><b>Open TripCheck &nearr;</b></div></a>
